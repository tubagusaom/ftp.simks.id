...
<table>
	...
	<tr>
		<td colspan="5" style="color:red"><b>PENARIKAN SEBELUMNYA SEDANG DIPROSES , Tunggu Aprove !</b></td>
	</tr>
...
<table>
	...
	<?php
		$nos=1;
		$sshu=0;
		$sqlshu	  ="SELECT * FROM SHU WHERE periode_shu LIKE '%$cari%' AND id_schm='$kodeschm' ORDER BY id DESC";
...
<table>
	<tr>
		<td colspan="4"><h1>Detail Penarikan <?php echo $kn=$_GET['namaa']; ?></h1></td>
	</tr>

	<?php if ($akses=='superuser' OR $akses=='admin') { ?>
	<td colspan="4">
	...
	<?php
		$nob=1;
		$sc	=0;
		$sqltpd	  ="SELECT * FROM trans_ambil WHERE efv_ambil LIKE '%$cari%' AND id_schm='$kodeschm' AND stts_ambil NOT LIKE '1' AND stts_ambil NOT LIKE '3' ORDER BY id DESC";
