...
<div style="width:100%">
  <div style="float:right">
    <b style="font-family:sans-serif; text-shadow: 0px 1px 1px #000;">
      <lable style="color:red;">OBS</lable>
      <lable style="color:#138ac9;">KOPERASI</lable>
    </b>
  </div>
...
<table width="100%" border="0" align="center" style="border:solid 2px black;border-collapse:collapse; font-size:13px">
  ...
  <tr align="center" style="border-bottom:solid 2px; background:rgba(0, 0, 0, 0.1)">
    ...
    <?php
      ...
      if ($kdcomp != "") {
        $company = "AND `akun`.`kd_comp` = $kdcomp";
      }else {
        $company = "";
      }
      ...
      $sql="SELECT
            ...
            WHERE
                ...
                `schm`.`stts_schm` NOT LIKE '6' $company
                $acuan OR
...
<?php
    ...
    header("Content-Disposition: attachment; filename=Export-Tagihan-Koperasi-$compe-MTH_HO$MTH.xls");
...
?>
  ...
  <table border="1">
    <tr align="center">
      <td style="width:10%">EMPNO</td>
      <td style="width:25%">EMPLOYEENAME</td>
      <td style="width:15%">PERIODCODE</td>
      <td style="width:10%">DEKOP</td>
    </tr>
    ...
    <tr>
      ...
      <td align="left">MTH_HO<?php echo date('m',strtotime($periode)); ?></td>
      <td align="right">
        <?php
        $jumlah=$data['pokok']+$data['wajib']+$data['sukarela']+$data['cicil']+$data['jasa'];
        echo $jumlah;
