	...
	<tr>
        ...
        include 'model/modul/casedate.php';
          ...
          $kka=substr($kodekirim,0,3);
					if ($hitung==0) {
						echo "Filter berdasarkan kode account <b style='text-decoration:underline; color:darkblue'>$kka</b>, Bulan <b style='text-decoration:underline; color:darkblue'>$abaa</b>, Tahun <b style='text-decoration:underline; color:darkblue'>$ftahun</b> Tidak ditemukan";
					}else {
						echo "Filter berdasarkan kode account <b style='text-decoration:underline; color:darkblue'>$kka</b>, Bulan <b style='text-decoration:underline; color:darkblue'>$abaa</b>, Tahun <b style='text-decoration:underline; color:darkblue'>$ftahun</b> jumlah <b style='text-decoration:underline; color:darkblue'>$hitung</b> data";
					}
				}else {
		...
		<td colspan="5">
          ...
          $saldoawal=$dsum-$ksum;
					...
					if ($akses=='superuser' OR $akses=='akunting') {
            if ($hitung==0) {
              echo "";
            }else {
			?>
