...
<form action="?Proses-Tambah-Pinjaman" method="post" onsubmit="return checkform(this);" class="form_input">
	<table>
		...
		<tr>
			<td>Anggota</td>
			<td>
        <select name="nama" required oninvalid="this.setCustomValidity('Silahkan Pilih Anggota')" oninput="setCustomValidity('')">
    ...
    <tr>
			...
			<td style="border-top:2px solid #999">
        <input type="text" name="nabank" value="" placeholder="nama bank" required oninvalid="this.setCustomValidity('Silahkan Masukan Nama Bank')" oninput="setCustomValidity('')">
			</td>
		</tr>
    <tr>
      <td></td>
      <td>
        <input type="text" name="norek" value="" placeholder="No Rekening" required oninvalid="this.setCustomValidity('Silahkan Masukan No Rekening')" oninput="setCustomValidity('')">
			</td>
		</tr>
    <tr>
      <td></td>
      <td>
        <input type="text" name="napem" value="" placeholder="Nama Pemilik" required oninvalid="this.setCustomValidity('Silahkan Masukan Nama Pemilik')" oninput="setCustomValidity('')">
			</td>
		</tr>
    <tr>
